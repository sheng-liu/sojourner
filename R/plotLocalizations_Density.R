...
##' plotLocalizations_Density(trackll=trackll,scale=128,r=125,file.No=0,point.scale=0.3)
##' # Plot only file No. 2 and increase the point size,
##' plotLocalizations_Density(trackll=trackll,scale=128,r=125,file.No=2,point.scale=1)
##' 
...
plotLocalizations_Density<-function(trackll=trackll,scale=256, r=125, file.No=0, point.scale=0.15){
