...
##' @param r Radius within each molecule to calculate density in nanometer (nm).
...
##' }
##' @details Plot localization map of molecules from a list of files in a folder
##'  with color coded 
...
plotLocalizations_Density<-function(trackll=trackll,scale=256, r=125, file.No=0,
                                    point.scale=0.15){
