...
##' number of tracks and result of two-component fitting shown in the plot area.
##' }
##' @details Calculating average residence time of particles by fitting 1-CDF 
##' (survival distribution) of its trajectorys.
##'
##' Input track list (trackll) should be processed, merged trackll, the fitting 
##' will start right away after running the function. 
##' The maximum time range to be plotted can be set using x.max, this will not 
##' change the fitting result. The result of two-component fit will be shown on 
##' the plot as well as in the console.
...
.one.comp.fit.rt=function(name,t,P,t.interval=t.interval,
    ...
    ## Equation for one component 1-CDF fitting. shift the values of time points
